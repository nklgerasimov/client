...
const Advantages = () => {
  return (
    <div className='advantages'>
        <AdvantageItem item={{img: <img src={risk}/>, title: 'Risk-free, 100-night mattress trial', subtitle: 'Try your new mattress in the comfort of your own home for 100 nights risk-free'}}/>
